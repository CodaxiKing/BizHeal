...
// Validate ../../src/app/api/analysis/monthly-revenue/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/analysis/monthly-revenue">> = Specific
  const handler = {} as typeof import("../../src/app/api/analysis/monthly-revenue/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/analysis/revenue-concentration/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/analysis/revenue-concentration">> = Specific
  const handler = {} as typeof import("../../src/app/api/analysis/revenue-concentration/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/notifications/mark-as-read/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/notifications/mark-as-read">> = Specific
  const handler = {} as typeof import("../../src/app/api/notifications/mark-as-read/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
